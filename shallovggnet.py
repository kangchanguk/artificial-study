...
model = Sequential([
    ...
    Dropout(0.2),
    Conv2D(192, 3, padding='same', activation='relu'),
    Conv2D(192, 1, padding='same', activation='relu'),
...
model.fit_generator(it_train, steps_per_epoch=train_images.shape[0]//64,epochs=10,verbose=1, validation_data=(test_images,test_labels),)
#model.fit(train_images,train_labels,epochs=10)
test_loss, test_acc = model.evaluate(test_images,  tetst_labels, verbose=2)
print(test_acc)
